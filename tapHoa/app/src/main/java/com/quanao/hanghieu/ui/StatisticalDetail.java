...
public class StatisticalDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ListItemAdapterManager(StatisticalDetail.this,lstCartItem);
        ...
        btnAccept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(StatisticalDetail.this,StatisticalActivity.class);
